...
This is the development of a singleton component to manage a logging system written in C++ in Godot. Simply place the dynamic libraries .so and .dll and the .gdextension file in the appropriate folder indicated below, and your project will automatically have the MyLogger class and the info(), warn(), and error() methods.
...
The code for this demo is available at : Third Person Character Demo

The same demo is available for First Person Character in https://jocarpe.itch.io/godots-first-person

This repository contains the component's .cpp and -h files, as well as the register_types -cpp and .h files necessary for compiling the module.
...
Este es el desarrollo de un componente singleton para gestionar un sistema de logs escrito en C++  en Godot tan sólo colocando las librerias dinámicas .so y .dll y el fichero .gdextension en la carpeta adecuada que se indica más abajo, automaticamente en tu proyecto dipondras de la clase MyLogger y los metodos info(), warn() y error() 
...
El código de esta demo lo tienes disponible en : Third Person Character Demo

La misma demo está disponible para personajes en primera persona en https://jocarpe.itch.io/godots-first-person

Este repositorio contiene los ficheros .cpp y -h del componente, asi como los ficheros register_types -cpp y .h necesarios para la compilación del módulo
